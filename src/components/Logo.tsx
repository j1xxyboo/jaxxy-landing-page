export default function Logo() {
  return (
    <a href="#top" className="flex items-center gap-2.5">
      <span className="flex h-8 w-8 items-center justify-center rounded-[10px] bg-gradient-to-br from-indigo-500 to-violet-600 shadow-glow">
      ...
      <span className="text-[19px] font-semibold tracking-tight text-white">Jaxxy</span>
    </a>
  );
}
