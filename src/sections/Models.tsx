          ...
          {MODELS.map((model) => (
            ...
            >
              <div className="flex items-center justify-between">
                <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-panel">
                  <ModelMark shape={model.shape} tone={model.tone} />
                </span>
                <span className="rounded-full bg-panel px-2.5 py-1 text-[11px] font-semibold text-neutral-500">
